...
8. ✅ Task 8: 领队权限与团队数据 - Complete

### Features Implemented

1. **用户角色系统**：支持家庭用户、成员、领队三种角色，首次使用时选择，支持更改
2. **行为采集系统**：无感记录页面访问、停留时长、点击行为、搜索行为、打卡行为
3. **观察期机制**：打卡3次/使用7天/查看10个攻略后开始评估，观察期有积极反馈
4. **六维素养评估算法**：基于关注度、参与度、深度、反馈四个维度加权计算
5. **雷达图组件**：使用原生Canvas绘制六维素养雷达图
6. **报告生成系统**：支持家庭用户（温馨型）、成员（游戏型）、领队（专业型）三种报告
7. **PDF导出功能**：支持单次报告导出和多选打卡记录导出
8. **领队权限与团队数据**：领队可查看团队所有成员数据
